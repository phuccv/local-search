...
public class SearchTabuAssign implements SearchMethod {
	 ...
	 */
	public SearchTabuAssign(IConstraint cs, SearchTraceable tracer, Config config){
	 ...
	 * @return 
	 */
	private int searchAssign(int tabuLength, int maxTimeSeconds, 
...
//				nonStableCount = 0;
	...
	public void run() {
		...
		searchAssign(tabuLength, maxTimeSeconds, maxIterator, maxStable, maxResetForOneLocal);
	}
